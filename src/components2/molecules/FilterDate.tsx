...
const FilterDate = ({ onSubmit }:FilterDateProps) => {
  ...
  return (
    ...
    <button
                    className="flex flex-row gap-3 rounded-[7px] bg-fuchsia-500 px-6 py-3 font-medium text-gray-2 hover:bg-opacity-90 dark:bg-opacity-50 dark:hover:bg-opacity-60"
                    type="submit"
                  >
